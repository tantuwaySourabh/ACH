...
public class ProfileImageUtil {
    ...
    public ProfileImageUtil(Context context, ImageView imageView) {
...
//                }
    ...
    public void onSelectCamera() {
        ...
        File f = new File(Environment.getExternalStorageDirectory(), "profiletemp.jpg");
    ...
    public File getFile() {
        imageFile = new File(Environment.getExternalStorageDirectory() + File.separator + "" + "temp1.jpeg");

        //Log.d("array", byteArray);
